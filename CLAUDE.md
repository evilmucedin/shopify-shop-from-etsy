...
This repo also carries `AGENTS.md` (for Pi and other agent tools) and
`.github/copilot-instructions.md` (for VS Code / GitHub Copilot). Keep the three
in sync when you change shared conventions.
